      ...
      <div>
        ...
        <p id='bio' className='paragraph'> 
          I'm currently learning about multi-agent interaction within robotics. Specifically, how does machine learning allow us to learn from mistakes and achieve broader task generalization? <br /> <br /> 
            ...
            (Summer 2022): Leveraged geotagged dataset of 6 Bay Area Newsrooms to analyze geographic demographic biases in comprehensive journalistic coverage through d.school process of constituent interviews and data analysis.&emsp; <br />
            [ <em><a href="https://docs.google.com/presentation/d/1Zw0ro4wZJipJ7EuglMAQ_-sUQhHjMriz_MwmibO9ky4/edit?usp=sharing" target="_blank">slides</a></em> ]
        </p>      
      </div>
    )
  }