      ...
      <div>
        ...
        <ul className="list-disc paragraph">
            ...
            <b>Computer Science</b>
                <li className="ml-5">131: Computer Vision - pose estimation, 3d object segmentation, with final project on using <a href="https://www.overleaf.com/project/67dec024aa8c8182eac65721" target="_blank">CNNs for Nanoparticle classification via XFEL Diffraction Interference</a>. I later helped teach this course with <a href="https://iskhare.github.io/" target="_blank">Ishan</a> and <a href="https://adriengaidon.com/" target="_blank">Adrien</a>. </li>
