export default function Hero() {
    return (
      <div>
        ...
        {/* 
           I'm deeply curious about "people systems"; the frameworks that govern how we interact and exchange with one another like the internet/journalism, financial markets, our political infrastructure, etc... 
